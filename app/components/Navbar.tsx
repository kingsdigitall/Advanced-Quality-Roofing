          ...
          <div className="mt-0 flex flex-row justify-between space-x-8 rounded-2xl rounded-tr-none text-sm font-medium md:mr-6 md:justify-around px-4">
            ...
            <div className="  hidden items-center justify-center lg:flex   ">
              <a id='cta-id' href={`tel:${ContactInfo.tel}`}>
                <button id='cta-id' className="flex items-center justify-center rounded bg-minor px-2 py-2 text-sm font-bold text-white   duration-200 ease-in-out hover:border-2 hover:border-main hover:bg-white hover:text-black md:px-4">
