  ...
  return (
    <div>
      <div className=" fixed  w-full md:block z-[200]">
        <div className="group fixed bottom-0 flex w-full items-center justify-center bg-main py-2 transition duration-200 ease-in group px-2  ">
          <div className="p-2 bg-main rounded-full -mt-8" >
          <MdOutlineRoofing  className="text-white text-5xl m-2 md:hidden " />
          </div>
