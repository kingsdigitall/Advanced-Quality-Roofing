    ...
    <div className="mx-auto max-w-[2100px] overflow-hidden">
      ...
      {ContentData.h5 && (
        <div className="mt-14 grid grid-cols-1  gap-10 px-6 md:mt-28 md:grid-cols-2 md:px-24 ">
          <div className="flex flex-col justify-center    ">
            <h2 className="text-first text-3xl font-bold">{ContentData.h5}</h2>
            <div
      ...
      {ContentData.h6 && (
        <div className="mt-14 grid grid-cols-1  gap-10 px-6 md:mt-28 md:grid-cols-2 md:px-24">
          ...
          <div className="flex flex-col justify-center    ">
            <h2 className="text-first text-3xl font-bold">{ContentData.h6}</h2>
            <div
        ...
        <div className="mt-14 px-6 md:mt-28 md:px-24">
          ...
          <div className="mt-10 grid grid-cols-1  gap-6 md:grid-cols-2">
            {ContentData?.pricingSection.list.map((item: any, index: any) => {
              return (
                <div className=" 1 rounded-md border p-4 shadow-md" key={index}>
      ...
      <div className="block w-full">
        <div className="mt-14 overflow-hidden rounded-xl border md:mt-20">
          <iframe
            ...
            height="350"
            width={"100%"}
            src={`https://maps.google.com/maps?q=${ContentData?.slug}+USA&t=&z=10&ie=UTF8&iwloc=&output=embed`}
            loading="lazy"
          ></iframe>
        </div>
      </div>
