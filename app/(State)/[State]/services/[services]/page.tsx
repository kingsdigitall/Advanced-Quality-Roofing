  ...
  return (
    <div className="">
      <div className="">
        <Navbar />
        <Banner
          h1={serviceData.title?.split("[location]").join(Data.name|| ContactInfo.location)
            ?.split("[phone]").join(ContactInfo.No)}
            image="https://ik.imagekit.io/serviceproviders/advancedqualityroofingaz.com/Affordable-Roof-Service-min.png?updatedAt=1749641055669"
          header=""
            ...
            <div className="flex flex-col justify-center">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: serviceData.p2?.split("[location]").join( Data.name||ContactInfo.location)
            ?.split("[phone]").join(ContactInfo.No),
                }}
              ></div>
            </div>
